<div>
    ...
    <div class="page-header-left d-flex align-items-center">
        <div class="page-header-title">
            <h5 class="m-b-10">{{ $withdrawal ? 'Edit Withdrawal' : 'Add Withdrawal' }}</h5>
        </div>
        <ul class="breadcrumb">
            <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Home</a></li>
            <li class="breadcrumb-item"><a href="{{ route('withdrawals.index') }}">Withdrawals</a></li>
            <li class="breadcrumb-item">{{ $withdrawal ? 'Edit' : 'Add' }}</li>
        </ul>
    </div>
    @endsection
                    ...
                    <form wire:submit="save" novalidate>
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="date" class="form-control @error('withdrawn_at') is-invalid @enderror" wire:model="withdrawn_at">
                        ...
                        <div class="mt-4 d-flex gap-2">
                            <button type="submit" class="btn btn-primary">
                                <i class="feather-save me-2"></i>{{ $withdrawal ? 'Update' : 'Create' }}
                            </button>
