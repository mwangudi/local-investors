...
@php
    ...
    $badgeContainerClasses = 'fi-link-badge-ctn absolute start-full top-0 z-[1] w-max -translate-x-1/4 -translate-y-3/4 rounded-none bg-white dark:bg-gray-900 rtl:translate-x-1/4';
