...
<{{ $tag }}
    ...
    {{
        $attributes
            ...
            ->class([
                'fi-tabs-item group flex items-center justify-center gap-x-2 whitespace-nowrap rounded-none px-3 py-2 text-sm font-medium outline-none transition duration-75',
