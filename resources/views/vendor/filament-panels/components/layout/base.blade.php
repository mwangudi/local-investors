...
<head>
    ...
    {{-- Your validation JS --}}
    <script src="{{ asset('js/filament/filament/admin/validation.js') }}" defer></script>
...
<body
    ...
    x-data="filamentPanels"                     {{-- 🔥 REQUIRED FOR INLINE VALIDATION --}}
    x-bind:class="{ 'fi-ready': $store.theme.mode }"
    x-on:alpine:init.window="window.dispatchEvent(new Event('filament:init'))"
>
