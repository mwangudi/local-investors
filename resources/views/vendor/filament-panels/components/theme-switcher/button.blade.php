...
<button
    ...
    class="fi-theme-switcher-btn flex justify-center rounded-none p-2 outline-none transition duration-75 hover:bg-gray-50 focus-visible:bg-gray-50 dark:hover:bg-white/5 dark:focus-visible:bg-white/5"
    x-bind:class="
        theme === @js($theme)
